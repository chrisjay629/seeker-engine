...
I'm not a developer who read about business. I'm an operator who learned to build the tools I always
wished I had — 10+ years running high-volume operations in Austin, now building with Claude and
Cursor. I didn't write most of this code line by line. I decided what to build, set the standards it
had to meet, and kept asking why it wasn't working until the real reasons surfaced.

That's the part worth evaluating. The bugs that mattered weren't found by reading code — they were
found by auditing a process: is everything we paid for actually being used? Why are we collecting
data nobody reviews? Did this ship, or does it just look shipped? The
[what I got right](#what-i-got-right) section is those questions and what each one uncovered.
